...
Riportiamo sempre e tabella: 

\begin{figure}[H]
\centering
\begin{minipage}{0.50\textwidth}
\centering
\includegraphics[width=0.91\linewidth]{Efficiency Curves - VETO.png}
...
\centering
    \begin{minipage}{0.4\textwidth}
        \includegraphics[width=\linewidth]{Periodo.pdf}
        \caption{Periodi misurati per il segnale di calibrazione}
        \label{fig:placeholder}
    \end{minipage}
    \begin{minipage}{0.5\textwidth}
        \includegraphics[width=\linewidth]{Ritardo.pdf}
...
In sede di analisi abbiamo dovuto tagliare molti punti presi a intervalli di tempo piccoli, in quanto i canali li presenti sono popolati principalmente da rumore after-pulse, con conseguente distorsione dell'esponenziale e mancata convergenza dei parametri su valori fisicamente sensati.
...
E calcoliamo l'integrale, proporzionale alle occorrenze per ciascuna carica $N_{\pm}$. Il risultato viene poi rapportato, ottenendo l'abbondanza relativa $r = \frac{N_+}{N_-}$. 

Come stima d'errore, ragioniamo assumendo di trattare l'area come una variabile Poissoniana, calcolando l'errore sul rapporto come:

\begin{center}
    $\sigma_r = r\sqrt{\frac{1}{N_+}+\frac{1}{N_-}}$
\end{center}

Con questa procedura, otteniamo : 

\begin{center}
$r= \frac{N_+}{N_-} = 1.07 \pm 0.08$
\end{center}

Il valore atteso è di 1.2766 $\pm$ 0.32 (stats.) $\pm$ 0.32 (syst.), compatibile con la nostra misura.
